            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full rounded-md px-3 py-3 pr-10 text-base leading-6 text-color placeholder-colorall outline-hidden border border-transparent focus:border-blue-500 transition-colors"
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full rounded-md px-3 py-3 pr-10 text-sm text-colorall placeholder-color outline-hidden border border-transparent focus:border-blue-500 transition-colors"
                />
                <button
                  type="button"
